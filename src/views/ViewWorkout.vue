<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
      ...
      <div class="flex flex-col items-center p-8 rounded-md shadow-md 
      bg-light-grey relative">
        ...
        <span class="mt-6 py-1.5 px-5 text-xs text-white bg-at-light-green
      ...
      <!-- Exercises -->
      <div class="mt-10 p-8 rounded-md flex flex-col item-center
      bg-light-grey shadow-md">
        ...
        <div v-if="data.workoutType === 'strength'" class="flex flex-col gap-y-4 w-full">
          <div 
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input v-if="edit" id="weight" class="p-2 w-full text-gray-500 focus:outline-none" type="text"
                v-model="item.weight" />
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          ...
          <button @click="addExercise" v-if="edit" type="button" class="py-2 px-6 rounded-sm self-start text-sm text-white
            bg-at-light-green duration-200 border-solid border-2 border-transparent
            hover:border-at-light-green hover:bg-white hover:text-at-light-green">
            Add Exercise
          </button>
